        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div class="lg:col-span-8 space-y-12">
                ...
                <div class="flex items-center gap-8 border-b border-slate-200 pb-px overflow-x-auto custom">
                    <button
                        class="pb-3 border-b-2 border-slate-900 dark:border-orange-200 text-slate-900 dark:text-slate-200 font-medium text-sm whitespace-nowrap">Lectures
                        récentes</button>
                    <button
                        class="pb-3 border-b-2 border-transparent hover:border-slate-200 text-slate-500 hover:text-slate-700 font-medium text-sm transition-colors whitespace-nowrap">Histoires
                        lues</button>
                    <button
                        class="pb-3 border-b-2 border-transparent hover:border-slate-200 text-slate-500 hover:text-slate-700 font-medium text-sm transition-colors whitespace-nowrap">Histoires
                        appréciées</button>
                ...
                <section>
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-lg font-display font-semibold text-slate-900 tracking-tight dark:text-white">
                            Reprendre la lecture</h2>
                    </div>

                    <div class="grid gap-4">
                        <!-- Continue Reading Card 1 -->
                        <div class="group relative flex flex-col sm:flex-row gap-4 p-4 rounded-2xl bg-white dark:bg-slate-300 border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 hover:border-slate-200"
                            @click="openTheChapterDetail('/books/book-uuid-1/chapter/chapter-uuid-1')">
                            <div
                                class="w-full sm:w-24 h-32 sm:h-36 bg-slate-100 rounded-lg overflow-hidden flex-shrink-0">
                            ...
                            <div class="flex flex-col justify-between py-1 flex-grow">
                                <div>
                                    <div class="flex items-center justify-between mb-1">
                                        <span
                                            class="text-[10px] font-bold tracking-wider text-orange-600 bg-orange-50 px-2 py-0.5 rounded-full uppercase">Fantastique</span>
                        ...
                        <div class="group relative flex flex-col sm:flex-row gap-4 p-4 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 hover:border-slate-200 opacity-75 hover:opacity-100"
                            @click="openTheChapterDetail('/books/book-uuid-4/chapter/chapter-uuid-1')">
                            <div
                                class="w-full sm:w-24 h-32 sm:h-36 bg-slate-100 rounded-lg overflow-hidden flex-shrink-0">
                            ...
                            <div class="flex flex-col justify-between py-1 flex-grow">
                                <div>
                                    <div class="flex items-center justify-between mb-1">
                                        <span
                                            class="text-[10px] font-bold tracking-wider text-slate-500 bg-slate-100 px-2 py-0.5 rounded-full uppercase">Drame</span>
                                        <span class="text-xs text-slate-400">Hier</span>
                                    </div>
                                    <h3
                                        class="font-display font-medium text-lg text-slate-900 group-hover:text-orange-600 transition-colors">
                                        Les Larmes du Fleuve</h3>
                                    <p class="text-sm text-slate-500">Chapitre 12: La séparation</p>
                                </div>

                                <div class="mt-4 sm:mt-0">
                                    <button
                                        class="mt-3 w-full sm:w-auto px-4 py-2 bg-slate-900/80 text-white text-xs font-medium rounded-lg hover:bg-slate-800 transition-colors flex items-center justify-center gap-2">
                                        Continuer
                                        <span
                                            class="border-white flex items-center justify-center md:border md:p-0.5 rounded-full md:w-4 md:h-4">
                                            <Icon name="mdi:play-outline" class="w-5 h-5 md:w-4 md:h-4 text-white" />
                ...
                <section>
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-lg font-display font-semibold text-slate-900 dark:text-white tracking-tight">À
                            lire plus tard</h2>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                        ...
                        <nuxt-link to="#" class="group">
                            <div
                                class="relative aspect-[2/3] bg-slate-100 rounded-xl overflow-hidden mb-3 shadow-sm border border-slate-100">
                                <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=400"
                                    class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <h4
                                class="font-display font-medium text-sm text-slate-900 dark:text-white truncate group-hover:text-orange-600">
                                Sous le ciel...</h4>
                        ...
                        <nuxt-link to="#" class="group">
                            <div
                                class="relative aspect-[2/3] bg-slate-100 rounded-xl overflow-hidden mb-3 shadow-sm border border-slate-100">
                                <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=400"
                                    class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            </div>
                            <h4
                                class="font-display font-medium text-sm text-slate-900 dark:text-white truncate group-hover:text-orange-600">
            ...
            <div class="lg:col-span-4 space-y-8">
                <div>
                    <h3 class="font-display font-semibold text-slate-900 dark:text-white mb-4 text-sm">Auteurs suggérés
                    </h3>
                    <div class="space-y-4">
                        <!-- Item 1 -->
                        <div :class="`flex items-center justify-between ${index !== authors.length - 1 ? 'border-slate-200 border-b-[1px] pb-2' : ''}`"
                            ...
                            <nuxt-link :to="`/authors/${author.uuid}`"
                                class="text-[12px] font-medium bg-slate-900 dark:bg-slate-800 text-white px-3 py-1.5 rounded-lg hover:bg-slate-800 transition-colors">Voir</nuxt-link>
                        </div>
                    </div>
                </div>
            </div>
