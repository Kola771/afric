<template>
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div>
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-200 mt-1">154 histoire(s)</p>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="bg-white dark:bg-slate-100 p-4 rounded-xl border border-slate-200 shadow-sm">
                ...
                <div class="flex items-end justify-between">
                    <p class="text-2xl font-display font-bold text-slate-900">54</p>
                </div>
            </div>
            <div class="bg-white dark:bg-slate-100 p-4 rounded-xl border border-slate-200 shadow-sm">
            ...
            <div class="bg-white dark:bg-slate-100 p-4 rounded-xl border border-slate-200 shadow-sm">
                ...
                <div class="flex items-end justify-between">
                    <p class="text-2xl font-display font-bold text-slate-900">70</p>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm">
                        <tr class="group hover:bg-slate-50 transition-colors border-b border-slate-50"
                            ...
                            <td class="py-3 px-6 text-slate-600 whitespace-nowrap"><nuxt-link
                                    class="hover:underline hover:text-orange-600 dark:hover:text-orange-500 hover:duration-300 hover:ease-linear"
                                    to="/dashboard/authors/author-uuid-1">Amadou Bah</nuxt-link></td>
                            <td class="py-3 px-6">
            ...
            <div class="flex items-center justify-between p-4 border-t border-slate-100">
                <span class="text-xs text-slate-500">Affichage de <span class="font-medium text-slate-900">1-4</span>
                    sur <span class="font-medium text-slate-900">400</span> histoires</span>
        ...
        <DashboardCategoryDeleteDetail @close-delete-modal="toggleDeleteModal" :showDeleteModal="showDeleteModal"
