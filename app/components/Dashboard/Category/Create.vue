    ...
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-200 mt-1">Créez une nouvelle catégorie pour organiser votre contenu.</p>
            </div>
        </div>
