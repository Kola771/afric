                  ...
                  <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      <DialogTitle as="h3" class="text-base font-semibold text-gray-900 dark:text-white">
                        Modifier le statut de l’histoire "<strong class="text-amber-600 dark:text-amber-500">{{
                          book.title }}</strong>"
                      </DialogTitle>
                      <div class="mt-2">
                        <p class="text-sm text-gray-500 dark:text-slate-200">
                          Passage de <strong>{{ status(book.status) }}</strong> à <strong class="text-amber-400">{{
                            status(statut) }}</strong>
                        </p>
                      </div>
                    </div>
                  </div>
