        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div class="flex gap-3">
                <button @click="exportBooks"
                    class="dark:bg-transparent dark:border dark:border-slate-200 dark:text-slate-200 h-9 px-4 rounded-lg bg-white dark:bg-slate-100 border border-slate-200 text-xs font-medium text-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 shadow-sm transition-colors flex items-center gap-2">
