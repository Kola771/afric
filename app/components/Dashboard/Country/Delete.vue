              ...
              <DialogPanel
                  ...
                  <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      <DialogTitle as="h3" class="text-base font-semibold text-gray-900 dark:text-white">Supprimer le
                        pays "<strong class="text-orange-600 dark:text-orange-500">{{ props.country.name }}</strong>"
                      </DialogTitle>
                      <div class="mt-2">
                        <p class="text-sm text-gray-500 dark:text-slate-200">Êtes-vous sûr de vouloir supprimer ce pays
                          ? Tous les utilisateurs liés à ce pays seront supprimés définitivement 10 jours plus tard
                ...
                <div class="dark:bg-slate-800 bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  <button type="button"
                    ...
                    @click="deleteCountry">Supprimer</button>
                  <button type="button"
