<template>
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="bg-white dark:bg-slate-100 p-4 rounded-xl border border-slate-200 shadow-sm">
                <p class="text-xl font-medium text-red-500 mb-1">5%</p>
                <div class="flex items-end justify-between">
        ...
        <div class="bg-white p-3 rounded-xl border border-slate-200 shadow-sm">
            ...
            <div class="flex items-center gap-3 w-full">
                <div class="relative flex-1">
                    ...
                    <input type="search" placeholder="Rechercher un pays..." class="h-8 pl-8 pr-3 w-full rounded-lg bg-slate-50 border border-slate-200 text-xs focus:outline-none focus:ring-1 focus:ring-slate-300 transition-colors">
                </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                        ...
                        <tr class="group hover:bg-slate-50 transition-colors border-b border-slate-50" v-for="index in 4" :key="index">
                            <td class="py-3 px-6">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="font-medium text-slate-900 group-hover:text-orange-600 transition-colors">Bénin</span>
                                </div>
                            </td>
            ...
            <div class="flex items-center justify-between p-4 border-t border-slate-100">
                <span class="text-xs text-slate-500">Affichage de <span class="font-medium text-slate-900">1-4</span> sur <span class="font-medium text-slate-900">15</span> pays</span>
