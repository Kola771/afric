    ...
    <div class="max-w-6xl mx-auto space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h2
                        ...
                        <span>Histoires de <strong class="text-orange-600 dark:text-orange-500">Amadou
                                Bah</strong></span>
                    </h2>
                    <p class="mt-1 text-sm text-slate-500 dark:text-slate-200">Originaire du/de : Congo;
                        amadoubah@gmail.com</p>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="bg-white dark:bg-slate-100 p-4 rounded-xl border border-slate-200 shadow-sm">
                ...
                <div class="flex items-end justify-between">
                    <p class="text-2xl font-display font-bold text-slate-900">42</p>
            ...
            <div class="bg-white dark:bg-slate-100 p-4 rounded-xl border border-slate-200 shadow-sm">
                ...
                <div class="flex items-end justify-between">
                    <p class="text-2xl font-display font-bold text-slate-900">7</p>
            ...
            <div class="bg-white dark:bg-slate-100 p-4 rounded-xl border border-slate-200 shadow-sm">
                ...
                <div class="flex items-end justify-between">
                    <p class="text-2xl font-display font-bold text-slate-900">10</p>
        ...
        <div
            ...
            <div class="flex bg-slate-100 p-1 rounded-lg overflow-x-auto max-w-full">
                <button
                    class="px-3 py-1.5 text-xs font-medium bg-white dark:bg-slate-50 text-slate-900 shadow-sm rounded-md transition-all whitespace-nowrap">Tous</button>
                <button
                    class="px-3 py-1.5 text-xs font-medium text-slate-500 hover:text-slate-700 transition-all whitespace-nowrap">Terminées</button>
                <button
                    class="px-3 py-1.5 text-xs font-medium text-slate-500 hover:text-slate-700 transition-all whitespace-nowrap">En
                    cours</button>
                <button
                    class="px-3 py-1.5 text-xs font-medium text-slate-500 hover:text-slate-700 transition-all whitespace-nowrap">En
                    pause</button>
                <button
                    class="px-3 py-1.5 text-xs font-medium text-slate-500 hover:text-slate-700 transition-all whitespace-nowrap">Brouillon</button>
                <button
                    class="px-3 py-1.5 text-xs font-medium text-slate-500 hover:text-slate-700 transition-all whitespace-nowrap">Inactive</button>
            </div>
            ...
            <div class="flex items-center gap-3 w-full sm:w-auto">
                <div class="relative flex-1 sm:flex-none">
                    ...
                    <input type="search" placeholder="Rechercher une histoire..."
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm">
                        <tr class="group hover:bg-slate-50 transition-colors border-b border-slate-50">
                            <td class="py-3 px-6">
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-10 bg-slate-200 rounded object-cover overflow-hidden">
                                        <img src="https://images.unsplash.com/photo-1544947950-fa07a98d237f?auto=format&fit=crop&q=80&w=100"
                                            class="w-full h-full object-cover opacity-80">
                                    </div>
                                    <span
                                        class="font-medium text-slate-900 group-hover:text-orange-600 transition-colors">Les
                                        Larmes du Soleil</span>
                                </div>
                            </td>
                            ...
                            <td class="py-3 px-6">
                                <nuxt-link to="/dashboard/stories/story-uuid-14/detail-like-comment"
                                    class="flex items-center gap-4">
                                    <span class="text-xs">
                                        <span class="font-semibold text-slate-900 dark:text-slate-700">42</span> <span
                                    ...
                                    <span class="text-xs">
                                        <span class="font-semibold text-slate-900 dark:text-slate-700">12k</span> <span
                                            class="text-slate-400">
                                    ...
                                    <span class="w-px h-3 bg-slate-200"></span>
                                    <span class="text-xs">
                                        <span class="font-semibold text-slate-900 dark:text-slate-700">1.1k</span> <span
                                            class="text-slate-400">
                            ...
                            <td class="py-3 px-6 whitespace-nowrap">
                                <span
                                    class="inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-[10px] font-medium bg-green-50 text-green-700 border border-green-100">
                                    <span class="w-1 h-1 rounded-full bg-green-600"></span>
                                    Terminée
                                </span>
                            </td>
                            <td class="py-3 px-6 text-right">
                                <nuxt-link to="/dashboard/stories/story-uuid-1"
                        ...
                        <tr class="group hover:bg-slate-50 transition-colors border-b border-slate-50">
                            <td class="py-3 px-6">
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-10 bg-slate-200 rounded object-cover overflow-hidden">
                                        <img src="https://images.unsplash.com/photo-1532012197267-da84d127e765?auto=format&fit=crop&q=80&w=100"
                                            class="w-full h-full object-cover opacity-80">
                                    </div>
                                    <span
                                        class="font-medium text-slate-900 group-hover:text-orange-600 transition-colors">L'Héritage
                                        Perdu</span>
                                </div>
                            </td>
                            <td class="py-3 px-6 whitespace-nowrap">
                            ...
                            <td class="py-3 px-6 whitespace-nowrap">
                                <span
                                    class="inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-[10px] font-medium bg-amber-50 text-amber-700 border border-amber-100">
                        ...
                        <tr class="group hover:bg-slate-50 transition-colors">
                            <td class="py-3 px-6">
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-10 bg-slate-200 rounded object-cover overflow-hidden">
                                        <img src="https://images.unsplash.com/photo-1512820790803-83ca734da794?auto=format&fit=crop&q=80&w=100"
                                            class="w-full h-full object-cover opacity-80">
                                    </div>
                                    <span
                                        class="font-medium text-slate-900 group-hover:text-orange-600 transition-colors">Chroniques
                                        d'Abidjan</span>
                                </div>
                            </td>
                            <td class="py-3 px-6 whitespace-nowrap">
            ...
            <div class="flex items-center justify-between p-4 border-t border-slate-100">
                <span class="text-xs text-slate-500">Affichage de <span class="font-medium text-slate-900">1-4</span>
                    sur <span class="font-medium text-slate-900">42</span> histoires</span>
                <div class="flex gap-2">
                    <button
                        ...
                        :disabled="true">Précédent</button>
                    <button
                        class="px-3 py-1.5 rounded-lg border border-slate-200 text-xs font-medium text-slate-900 hover:bg-slate-50">Suivant</button>
                </div>
            </div>
        </div>
