<template>
  <div
    ...
    <button v-if="showScrollTop" @click="scrollToTop"
      class="fixed bottom-16 lg:bottom-6 flex items-center justify-center right-3 md:right-6 z-30 bg-slate-900 text-white p-2.5 lg:p-3 rounded-full shadow-xl hover:bg-slate-800 transition-all duration-300 dark:bg-white dark:text-slate-900">
