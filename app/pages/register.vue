<template>
    <div>
        <div class="flex h-full">
            ...
            <div
                class="flex dark:lg:border flex-1 flex-col justify-center px-4 py-8 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-white dark:bg-dark z-10 relative overflow-y-auto min-h-screen scrollbar-hide">
                <div class="mx-auto w-full max-w-sm lg:w-[420px] py-8">
                    ...
                    <!-- Header -->
                    <div>
                        <h2 class="text-2xl font-display font-bold tracking-tight text-slate-900 dark:text-white">Créer
                            un compte {{ author ? 'auteur' : 'lecteur' }}</h2>
                        <p class="mt-2 text-sm text-slate-500 dark:text-slate-200">
                            Déjà membre ?
                            <nuxt-link to="/login"
                                class="font-medium text-orange-600 dark:text-orange-500 hover:text-orange-500 transition-colors hover:underline">Se
                                connecter</nuxt-link>
                        </p>
                    </div>
                        ...
                        <form @submit.prevent="registerFunction" class="space-y-5" id="registerForm">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="col-span-1">
                                    <label for="fullname"
                                        class="block text-xs font-medium leading-6 text-slate-900 dark:text-white">Nom
                                        complet</label>
                            ...
                            <div class="relative">
                                <label for="pays"
                                    class="block text-xs font-medium leading-6 text-slate-900 dark:text-white">
                                    Pays d'origine
                                </label>
                                ...
                                <ul v-if="showDropdown && filteredCountries.length"
                                    ...
                                    <li v-for="(c, index) in filteredCountries" :key="index"
                                        ...
                                        class="px-3 py-2 text-sm cursor-pointer hover:bg-orange-100 dark:hover:bg-slate-700 dark:text-slate-200" :class="index !== filteredCountries.length - 1 ? 'border-b-[1px] border-slate-300' : ''">
                                        {{ c.name }}
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="col-span-2 sm:col-span-1">
                                    <label for="password"
                                        class="block text-xs font-medium leading-6 text-slate-900 dark:text-white">Mot
                                        de passe</label>
                                    <div class="mt-1 relative">
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    <label for="confirm_password"
                                        class="block text-xs font-medium leading-6 text-slate-900 dark:text-white">Confirmation</label>
                                    <div class="mt-1 relative">
                                        <input v-model="confirmPassword" id="confirm_password" name="confirm_password"
                                        ...
                                        <div
                                            ...
                                            <Icon id="status-icon" name="solar:check-circle-linear" width="20"
                                                class="hidden" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div v-if="author">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="text-xs scale-90 origin-right text-slate-400 dark:text-slate-200">Optionnel</span>
                                </div>
                                <div class="mt-1 relative">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 text-xs leading-5">
                                    <label for="terms" class="text-slate-600 dark:text-white">J'accepte les <nuxt-link
                                            to="/conditions"
                                            class="font-medium text-orange-600 hover:text-orange-500 hover:underline dark:text-orange-500">Conditions</nuxt-link>
                                        et la <nuxt-link to="/privacy-policy"
                                            class="font-medium text-orange-600 hover:text-orange-500 hover:underline dark:text-orange-500">Politique</nuxt-link>.</label>
                                </div>
                            </div>
