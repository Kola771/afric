            ...
            <div class="p-4 md:p-10 lg:p-12">
                <div class="grid md:grid-cols-12 gap-10">
                    ...
                    <div class="md:col-span-8 lg:col-span-9 space-y-8">
                        <div>
                            <div class="flex items-center gap-3 text-xs font-medium text-orange-600 mb-4">
                                <span
                                    class="bg-orange-50 border border-orange-100/50 text-orange-600 text-xs font-medium animate-fade-in-up px-2 py-1 rounded">FANTASTIQUE</span>
                            ...
                            <div class="flex items-center gap-6 text-sm text-slate-500 dark:text-slate-200">
                                <nuxt-link to="/authors/alain_mabanckou"
                                    class="flex items-center gap-2 hover:underline hover:ease-in-out hover:duration-300">
                                    <img src="/assets/alain_mabanckou.jpg" class="w-6 h-6 rounded-full" alt="Author">
                                    <span class="text-slate-900 font-medium dark:text-white truncate">Alain Mabanckou
                                    </span>
                                </nuxt-link>
                        ...
                        <div class="prose prose-slate prose-sm max-w-none text-slate-600 dark:text-slate-200">
                            <p>Dans un Dakar futuriste où la technologie se mêle à la magie ancestrale, Malik découvre
                                un masque ancien dans les archives du musée des Civilisations Noires. Ce simple artefact
                                va bouleverser sa vie et réveiller des esprits oubliés depuis des siècles. Traqué par
                                une société secrète, il doit comprendre ses origines avant que l'ombre ne recouvre la
                                ville lumière.</p>
                        </div>
                        <!-- Chapters List -->
                        <div class="border-t border-slate-200 pt-6">
                            <h3 class="font-display font-medium text-slate-900 dark:text-white mb-4">Chapitres</h3>
                            <div class="space-y-2 md:max-h-96 md:overflow-y-auto">
                                <nuxt-link v-for="chapter in chapters" :key="chapter.id"
            ...
            <div class="flex flex-col h-full lg:h-full lg:w-full">
                ...
                <div
                    ...
                    <h3 class="text-lg font-medium flex text-slate-900 dark:text-white max-w-2/3">
                        <span class="truncate">Le Masque d'Or</span>
                    </h3>
